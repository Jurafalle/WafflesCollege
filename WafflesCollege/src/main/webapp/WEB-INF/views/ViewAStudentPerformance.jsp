...
<div class="col-container">
  <nav>
       ...
       <a href="ViewCourseEnrolment.jsp" class="sidebar-button">View Course Enrolment</a>
       <a href="GradeACourse.jsp" class="sidebar-button">Grade a Course</a>
       <a href="ViewAStudentPerformance.jsp" class="sidebar-button"><b>View a Student Performance</b></a>
